...
For a more full-featured demo, check out [PicThang](https://github.com/dthyresson/pic-thang) from DT where he replicates [PicThing](https://pic.ping.gg/), a service for automated image background removal, rebuilt from scratch using Redwood with Background Jobs and the upcoming [Uploads & Storage functionality](https://docs.redwoodjs.com/docs/canary/uploads).
